...
def execute(filters=None):
	...
	#return get_column(), get_data(),'Hello world',chart(), summary()
	...
	return get_report_col(filters), report_data, message, report_chart, get_report_summary(filters,report_data),skip_total_row
